...
typewriter
    ...
    .pauseFor(2500)
    .deleteAll()
    .typeString("Spigot plugins developer.")
    .pauseFor(2500)
    .deleteAll()
    .typeString("Designer.")
    .pauseFor(2500)
